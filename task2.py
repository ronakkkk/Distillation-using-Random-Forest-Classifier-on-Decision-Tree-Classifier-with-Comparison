...
# read csv file
data = pandas.read_csv('audit_risk.csv')
...
# plot location id and risk
sns.barplot(x=data['Risk'], y=data['LOCATION_ID'])
plt.show()
...
figure.savefig("audit_distillation_decision_tree.png")
...
figure = plt.figure()
_ = sklearn.tree.plot_tree(dtree_model, feature_names = X.columns, class_names=df_bin.columns)
figure.savefig("audit_decision_tree.png")